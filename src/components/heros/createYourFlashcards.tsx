      ...
      <div className="overflow-hidden bg-white lg:mx-0  py-4 lg:flex lg:max-w-6xl lg:w-full lg:shadow-md lg:rounded-xl">
        <div className="max-w-xl px-6 py-12 lg:max-w-5xl lg:w-2/3">
          ...
          <div className="inline-flex w-full mt-6">
            ...
            <Link
              href="/login/signUp"
              className="inline-flex text-center items-center justify-center mx-4 px-6 py-2 text-sm text-white duration-300 bg-gray-900 rounded-lg hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80"
            >
              {t("actions.signUp")}
            </Link>
          </div>
